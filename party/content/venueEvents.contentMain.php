...
?>
								...
								<? if ($venueDetails["website"] != "") { ?>
									<tr class='text'>
										...
										<td><a target="_blank" href="<? echo $venueDetails["website"];?>"><? echo $venueDetails["website"];?></a></td>
									</tr>
								<? } ?>
								</table>
						<?
					...
					<td valign="top" align='center' width='250'>
						<?	
							...
							{ 
								...
								echo "<div align='center'><img class='imgBorder' src='".$venueDetails["imgURL"]."' border='0' width='200'>";
								echo "</div>";
								$layout->bubbleSubBoxBottom();
							} 
							/*
