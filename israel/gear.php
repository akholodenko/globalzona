          ...
          <tr> 
            <td bgcolor="#CCCCCC"><table width="700" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  ...
                  <td width="60%" bgcolor="#F2F2F2"><table width="100%" border="0" cellpadding="25" cellspacing="0" class="text">
                      <tr> 
                        <td valign="top" ><p align="right" class="textsmall"><? echo date("F j, Y, g:i a"); ?></p>
                          <p align="justify" class="text"><strong> UNDER CONSTRUCTION!</strong></p>
                          <hr size="1" noshade> 
                          <p align="justify" class="text">Coming soon...</p>
                          </td>
                      </tr>
                    </table></td>
